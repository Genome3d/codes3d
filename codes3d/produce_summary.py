...
if __name__ == "__main__":
	...
	parser.add_argument("-e","--eqtls_files",nargs='+',required=True,help="Space-separated list of one or more eQTL files generated by find_eqtls.py")
	...
	parser.add_argument("-c","--config",default="docs/codes3d.conf",help="The configuration file to be used in this instance (default: conf.py)")
