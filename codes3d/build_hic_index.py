...
if __name__ == "__main__":
	...
	parser.add_argument("-c2","--chr2_col",type=int,help="Column number of partner 2 chromosome (default: 7, NOT ZERO-BASED)")
	parser.add_argument("-f1","--frag1_col",type=int,help="Column number of partner 1 fragment (default: 5, NOT ZERO-BASED)")
	...
	parser.add_argument("-m","--mapq_cutoff",type=int,help="The minimum MAPQ score for a read to be considered (default: 30)")
