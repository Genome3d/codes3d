...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--snps_file", required=True, nargs='+',
                        help="The list of SNPs generated by process_inputs.py")
    parser.add_argument("-g", "--genes_file", required=True, nargs='+',
                        help="The list of genes generated by find_genes.py")
    parser.add_argument("-c", "--config", default=os.path.join(
        os.path.dirname(__file__), "../docs/codes3d.conf"),
        help="The configuration file to be used in " +
        "this instance (default: conf.py)")
